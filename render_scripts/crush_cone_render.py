...
def main():
    ...
    for i, mesh_file in enumerate(mesh_files):
        ...
        result = save_largest_and_minz_of_smallest(str(mesh_file), str(preprocessed_folder / f"{mesh_file.stem}_cone.ply"))
    ...
    camera_location = (0.000927, -0.177752, 0.100766)
    camera_rotation = (-52.8001, 0, 180)  # Euler rotation in degrees
    ...
    light_location = (-0.001815, -0.094071, -0.173927)  # Euler rotation in degrees
    light_rotation = (174.181, -1.48252, -4.43321)
    light_strength = 4.0
    shadow_softness = 0.3
